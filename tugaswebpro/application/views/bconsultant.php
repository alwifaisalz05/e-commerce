...
<body>
  ...
  ?>
        <div class="container" style="margin-left: 40px;">
          <div class="row">
            <div class="wrap" style="background-color: #F7F7F7; width:350px; height: 350px; border-radius: 5px; font-family: Century Gothic;">
              <br>
              <div class="inputdata">
                <textarea type="text" class="form-control" placeholder=" Tuliskan Masalah Bisnis Anda" required name="masalahbisnis" autofocus style="width: 300px; height: 180px; margin-left: 25px;"></textarea>
              </div>
              <br>
            ...
            <div class="col">
              <div class="col-sm" style="margin-top: 2px;">
                <iframe width="730" height="345" style="border-radius: 5px;" src="https://www.youtube.com/embed/hIvVT2al8a4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>  
            </div>
          </div>
        </div>
