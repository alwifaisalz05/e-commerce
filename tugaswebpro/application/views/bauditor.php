...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="<?php echo base_url(); ?>asset/images/img/bbb1.png" alt="First slide" height="120px">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url(); ?>asset/images/img/bbb2.png" alt="Second slide" height="120px">           
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url(); ?>asset/images/img/bbb3.png" alt="Third slide" height="120px">
        </div>
      </div>
    ...
    <br>
    <hr>
    <img id="comingsoon" src="<?php echo base_url(); ?>asset/images/img/comingsoon.png" height="100px" style="margin-left: 200px;">
    <hr>
    <!-- isi -->
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="col-sm" style="margin-top: 2px;">
                <iframe width="730" height="327" style="border-radius: 5px;" src="https://www.youtube.com/embed/AnfXO5UR9fU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>  
            </div>
          </div>
        </div>
