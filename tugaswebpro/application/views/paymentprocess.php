    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="<?php echo base_url(); ?>asset/images/img/bbbb1.png" alt="First slide" height="120px">
            ...
            <div class="carousel-item">
              <img class="d-block w-100" src="<?php echo base_url(); ?>asset/images/img/bbbb2.png" alt="Second slide" height="120px">
              <div class="carousel-caption d-none d-md-block">
                <h5></h5>
                <p></p>
              </div>           
        ...
        <div class="container" style="margin-left: 40px;">
          <div class="row">
            <div class="wrap" style="background-color: #F7F7F7; width:350px; height: 330px; border-radius: 5px; font-family: Century Gothic;">
              ...
              <br>     
              <div class="container">
                <button class="btn btn-info" style="width: 300px; margin-left: 10px;" onclick="window.location.href='<?php echo site_url('Akun_C/home');?>'">PROCESS</button>
              </div>
              <br>
            </div>
            <div class="col">
              <div class="col-sm" style="margin-top: 2px;">
                <iframe width="730" height="327" style="border-radius: 5px;" src="https://www.youtube.com/embed/gG5kLlfZcik" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>  
            </div>
          </div>
        </div>
