  ...
  <table align="center" class="table table-bordered table-hover table-striped" id="table-datatable" style="width: 1200px; font-family: Century Gothic;" >
    ...
    <tbody>
      ...
      foreach($wishlist as $w){ 
        ...
        <tr>
          <td><?php echo $no++; ?></td>
          <td><?php echo $w->kode ?></td>
          <td><?php echo $w->nama_barang ?></td>
          <td><?php echo $w->harga ?></td>       
          <td style="text-align: center;">
            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit<?php echo $w->kode; ?>">Edit</button>
            <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapus<?php echo $w->kode; ?>">Hapus</button>
          </td>
        </tr>
          <div id="edit<?php echo $w->kode; ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
              <div class="modal-content" style="font-family: Century Gothic">
                ...
                <?php echo form_open("home/editwish"); ?>
                <div class="modal-body">
                  <div class="form-group">
                    <label class="control-label" for="kode">Kode</label>
                    <input type="text" class="form-control" disabled value="<?php echo $w->kode;?>" id="kode">
                    <input type="hidden" name="kode" class="form-control" value="<?php echo $w->kode;?>" id="kode" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="nama_barang">Nama Barang</label>
                    <input type="text" name="nama_barang" class="form-control" value="<?php echo $w->nama_barang;?>" id="nama_barang" required>
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="harga">Harga</label>
                    <input type="text" name="harga" class="form-control" value="<?php echo $w->harga;?>" id="harga" required>
                  </div>
                </div>
          ...
          <div id="hapus<?php echo $w->kode; ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
